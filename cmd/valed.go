	...
	return dix.New(
		...
		dix.Modules(dix.NewModule(
			...
			dix.Providers(
				...
				dix.Contribute1[vale.GatewayComponent](provideWatchComponent, dix.Order(0)),
				dix.Contribute1[vale.GatewayComponent](provideLoggerComponent, dix.Order(10)),
				dix.Contribute1[vale.GatewayComponent](provideObservabilityComponent, dix.Order(20)),
				dix.Contribute1[vale.GatewayComponent](provideMetricsComponent, dix.Order(30)),
				dix.Contribute1[vale.GatewayComponent](provideConfigSourceComponent, dix.Order(40)),
				dix.ContributeErr1[vale.GatewayComponent](provideClusterComponent, dix.Order(50)),
				dix.Contribute1[vale.GatewayComponent](provideEventBusComponent, dix.Order(60)),
